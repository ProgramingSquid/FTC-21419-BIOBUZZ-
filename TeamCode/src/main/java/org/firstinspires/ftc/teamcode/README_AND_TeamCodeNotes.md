...
* `RobotHardware` looks up motors from the robot config file via name from `MotorDefinition`s and applies configurations like their directions and modes upon initialization.
